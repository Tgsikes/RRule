...
import org.rrule.RecurrenceRuleTrigger;
import org.rrule.RecurrenceRuleUtils;
...
/**
 * <p>
 * A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link org.rrule.JobDetail}</code> at given moments in time, defined with recurrence rules as defined in RFC 5545.
 * </p>
 * 
 */
public class RecurrenceRuleTriggerImpl extends AbstractTrigger<RecurrenceRuleTrigger> implements RecurrenceRuleTrigger, CoreTrigger {
     ...
     * 
     * @see TriggerUtils#computeFireTimesBetween(Trigger, org.rrule.Calendar , Date, Date)
     */
    @Override
     ...
     * 
     * <p>
     * Note that the date returned is NOT validated against the related org.rrule.Calendar (if any)
     * </p>
     * 
     * @param afterTime
     ...
     * 
     * <p>
     * Note that the return time *may* be in the past. and the date returned is not validated against org.rrule.calendar
     * </p>
     * 
