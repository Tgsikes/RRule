...
import org.rrule.impl.triggers.RecurrenceRuleTriggerImpl;
...
public class RecurrenceRuleScheduleBuilderTest {
    ...
    @Test
    public void newTriggerCreatesInstanceOfRRTrigger () {
    	RecurrenceRuleTrigger trigger = newTrigger().startNow()
    			...
    			.build();
    	assertTrue(trigger instanceof RecurrenceRuleTriggerImpl);
    }
    @Test
